...
class ProfileViewSet(viewsets.ModelViewSet):
    ...
    @swagger_auto_schema(
        ...
        operation_description="Retrieves a user's public profile information by"
        "slug.",
    )
    ...
    @swagger_auto_schema(
        ...
        operation_description="Creates a new user profile. Note: Profiles are "
        "typically created automatically when users register.",
        ...
        responses={
            ...
            400: openapi.Response(
                ...
                examples={
                    "application/json": {"error": "Invalid profile data"}
                },
            ),
        },
    )
    ...
    @swagger_auto_schema(
        ...
        operation_description="Completely updates a profile identified "
        "by its slug.",
        request_body=UpdateProfileSerializer,
        responses={
            ...
            404: openapi.Response(
                ...
                examples={"application/json": {"error": "Profile not found"}},
            ),
        },
    )
    ...
    @swagger_auto_schema(
        ...
        operation_description="Partially updates a profile identified by its "
        "slug. Only provided fields will be updated.",
        request_body=UpdateProfileSerializer,
        responses={
            200: openapi.Response(
